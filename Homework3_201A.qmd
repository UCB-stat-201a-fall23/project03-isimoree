...
\mu _2=3.846\\
0.8\mu _1 -0.7*3.846= 1; \\
\mu _1=4.615
\end{split}
$$


Theoretically the mean arrival time to the absorbing state are $\mu _1=4.615$ and $\mu _2=3.846$ that are pretty closed to the simulated means which underscores the accuracy of the estimates for the waiting time until the process reaches the absorbing state.
